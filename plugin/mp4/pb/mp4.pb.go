...
type ResponseList struct {
	...
	List       []*RecordFile `protobuf:"bytes,6,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *ResponseList) GetList() []*RecordFile {
	if x != nil {
		return x.List
	}
	return nil
...
var file_mp4_proto_rawDesc = []byte{
	...
	0x7a, 0x65, 0x12, 0x23, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0f, 0x2e, 0x6d, 0x70, 0x34, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x46, 0x69, 0x6c,
	0x65, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xaf, 0x01, 0x0a, 0x07, 0x43, 0x61, 0x74, 0x61,
...
var file_mp4_proto_depIdxs = []int32{
	...
	1,  // 2: mp4.ResponseList.list:type_name -> mp4.RecordFile
